(() => {
    ...
    let draggableFileArea = document.querySelector(".file-popup__area");
    let fileInput = document.querySelector(".default-file-input");
    let uploadedFile = document.querySelector(".file-popup__preview");
    let fileName = document.querySelector(".preview-file-popup__file-name");
    let errorBlock = document.querySelector(".file-popup__error-block");
    let removeFileButton = document.querySelector(".preview-file-popup__remove-file-icon");
    let fileFlag = 0;
    ...
    fileInput.addEventListener("change", (e => {
        if (fileInput.files[0].size > 5242880) {
            errorBlock.innerHTML = "Max file size: 5GB";
            return;
        }
